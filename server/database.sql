...
CREATE DATABASE bilgesis_teklif;
\c bilgesis_teklif;
...
CREATE INDEX idx_proposals_customer_name ON proposals(customer_name);
CREATE INDEX idx_proposals_reminder_date ON proposals(reminder_date);
